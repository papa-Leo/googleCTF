...
export function familyID(familyName) {
...
export function isUF2Block(data) {
...
export function decodeBlock(data) {
    if (data.length !== 512) {
    ...
    if (payloadSize > maxPayloadSize) {
        throw new UF2DecodeError(`Invalid payload size ${payloadSize}. Should be ${maxPayloadSize} bytes or less.`);
    }
    return {
        flags,
        flashAddress,
...
export function encodeBlock(blockData, target = new Uint8Array(512), targetOffset = 0) {
